...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1.2\textwidth]{figures/sysmlv2 diagrams/structure.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth, height=7cm, keepaspectratio]{figures/sysmlv2 diagrams/aggregationFlow.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth, height=7cm, keepaspectratio]{figures/sysmlv2 diagrams/synchronizationFlow.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth, height=7cm, keepaspectratio]{figures/sysmlv2 diagrams/idcFlow.png}
