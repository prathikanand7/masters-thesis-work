...
CREATE INDEX trace_scenario IF NOT EXISTS
  FOR (e:TraceEvent) ON (e.scenario_id, e.timestamp);
...
(C5: static + dynamic + slicing, \cref{sec:h1-results}).
Scenarios are represented as component-interaction edge lists
(\texttt{elements.json}) extracted from the sliced \ac{PG}.
