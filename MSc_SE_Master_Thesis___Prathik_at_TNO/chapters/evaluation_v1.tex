...
\begin{itemize}
  \item \textbf{H1} (\cref{sec:h1}) compares reconstruction accuracy
    across conditions C1--C9 (\cref{sec:conditions}) on four scenarios
    (\cref{sec:scenarios}), all occurring naturally in CPSCore (S1a, S1b,
    S2, S3).
...
\textbf{Hypothesis.} Guided instrumentation constrained by a Neo4j
reachability filter (C5) achieves higher reconstruction accuracy than any
single-source or unconstrained condition; full-trace instrumentation with
the same filter (C6) matches C5, confirming the filter alone is
sufficient regardless of instrumentation strategy.
...
\caption{H1 per-scenario results (interaction edges): precision / recall
  / F1 by condition. Scenarios S1a, S1b, S2, S3 all occur naturally in
  CPSCore (\cref{sec:scenarios}).}
\label{tab:h1-per-scenario}
\small
\begin{tabular}{@{} l c c c c @{}}
\toprule
\textbf{Condition} & \textbf{S1a} & \textbf{S1b} & \textbf{S2} & \textbf{S3} \\
\midrule
C1: LLM-only            & 1.00/1.00/1.00 & 1.00/1.00/1.00 & 1.00/1.00/1.00 & .75/1.00/.86 \\
C2: Static-only         & .50/1.00/.67   & .75/1.00/.86   & 1.00/1.00/1.00 & 1.00/.33/.50 \\
C3: Unfiltered trace    & .29/1.00/.44   & .38/1.00/.55   & .50/1.00/.67   & .30/1.00/.46 \\
C4: Guided-only         & .67/1.00/.80   & .75/1.00/.86   & 1.00/1.00/1.00 & 1.00/1.00/\textbf{1.00} \\
C5: Guided+Reach        & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} \\
C6: FullTrace+Reach     & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} \\
C7: LLM+C2              & 1.00/1.00/1.00 & 1.00/1.00/1.00 & 1.00/1.00/1.00 & .50/1.00/.67 \\
C8: LLM+C3              & 1.00/1.00/1.00 & 1.00/1.00/1.00 & 1.00/1.00/1.00 & .50/.67/.57 \\
C9: LLM+C4              & .67/1.00/.80   & 1.00/1.00/1.00 & 1.00/1.00/1.00 & .33/.33/.33 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[htb]
\centering
\caption{H1 per-scenario results (execution-order LCS metric): precision /
...
\textbf{Condition} & \textbf{S1a} & \textbf{S1b} & \textbf{S2} & \textbf{S3} \\
\midrule
C1: LLM-only            & 1.00/1.00/1.00 & 1.00/1.00/1.00 & 1.00/1.00/1.00 & .71/.77/.74 \\
C2: Static-only         & .50/.25/.33    & .75/.60/.67    & 1.00/1.00/1.00 & 1.00/.08/.14 \\
C3: Unfiltered trace    & .21/1.00/.34   & .18/1.00/.30   & .50/1.00/.67   & .25/1.00/.40 \\
C4: Guided-only         & .67/1.00/.80   & .56/1.00/.72   & 1.00/1.00/1.00 & .77/1.00/.87 \\
C5: Guided+Reach        & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} \\
C6: FullTrace+Reach     & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} & 1.00/1.00/\textbf{1.00} \\
C7: LLM+C2              & 1.00/1.00/1.00 & 1.00/1.00/1.00 & 1.00/1.00/1.00 & .56/.77/.64 \\
C8: LLM+C3              & 1.00/1.00/1.00 & 1.00/1.00/1.00 & 1.00/1.00/1.00 & .62/.62/.62 \\
C9: LLM+C4              & 1.00/1.00/1.00 & 1.00/1.00/1.00 & 1.00/1.00/1.00 & .58/.54/.56 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
C1: LLM-only          & 0.938 & \textbf{1.000} & 0.964 & 0.929 & 0.942 & 0.935 \\
C2: Static-only       & 0.812 & 0.833 & 0.756 & 0.812 & 0.482 & 0.536 \\
C3: Unfiltered trace  & 0.365 & \textbf{1.000} & 0.530 & 0.284 & \textbf{1.000} & 0.428 \\
C4: Guided-only       & 0.854 & \textbf{1.000} & 0.914 & 0.747 & \textbf{1.000} & 0.846 \\
C5: Guided+Reach      & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} \\
C6: FullTrace+Reach   & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} \\
C7: LLM+C2            & 0.875 & \textbf{1.000} & 0.917 & 0.889 & 0.942 & 0.911 \\
C8: LLM+C3            & 0.875 & 0.917 & 0.893 & 0.904 & 0.904 & 0.904 \\
C9: LLM+C4            & 0.750 & 0.833 & 0.783 & 0.896 & 0.885 & 0.890 \\
\bottomrule
\end{tabular}
\end{table}
...
\subsection{Discussion: C5 and C6 Achieve Perfect Scores}\label{sec:h1-c4c2}

Two conditions achieve F1~$=$~1.000 on both metrics across all four
scenarios: \textbf{C5 (guided~+~reachability)} and \textbf{C6
(full-trace~+~reachability)}. This confirms the central role of the
reachability filter, not the instrumentation strategy: replacing guided
with full-trace instrumentation while keeping the filter (C6~vs.~C5)
leaves every score unchanged.

The mechanism is straightforward. \texttt{trace\_slice.txt} probes fire
whenever an instrumented function is called --- including during
test-fixture setup before the scenario logic starts. Without the filter
(C4), \texttt{Aggregator.add}~$\to$~\texttt{RAIILogStream.stream} events
appear for S1a and S1b because those sites fire during setup. The
reachability filter keeps only events whose caller is reachable from the
scenario entry point via \texttt{CppCalls*0..8}: setup-phase callers are
not reachable, so their events are dropped. This eliminates C4's two
remaining false positives on S1a and S1b, yielding perfect scores.

S2 and S3 have no setup-phase noise in \texttt{trace\_slice.txt}, so C4
already achieves F1~$=$~1.000 there; C5 matches it. The filter adds
value exactly where needed and is otherwise a no-op.

\subsection{Discussion: Guided vs.\ Unfiltered and Static Limits}\label{sec:h1-c4c3}

C4 (guided-only, 0.914\,/\,0.846 macro) substantially outperforms C3
(unfiltered trace, 0.530\,/\,0.428): \texttt{trace\_slice.txt} instruments
only cross-component architectural call sites, so intra-component calls
never appear there, while \texttt{full\_trace.txt} captures all calls
including numerous intra-component ones. C3's false positives are real
runtime events; they are simply not scenario-relevant.

C2 (static-only, 0.756\,/\,0.536 macro) is structurally capped on S3 by
an indirect dispatch: \texttt{Utilities}~$\to$~\texttt{Logging:stream} is
routed through a \texttt{std::function}-wrapped thread with no resolvable
static call site, so \texttt{CppCalls} never records it. C2's precision
on S3 is 1.000 (it reports no extraneous edges, only an incomplete set);
its recall is 0.333 (one of three genuine edges). No Cypher refinement
can recover a call site that is structurally absent from the call graph.
C5 and C6 recover it because the trace captures the executed call.

\subsection{Discussion: LLM-Augmented Conditions Underperform Their Counterparts}\label{sec:h1-c5}

C7 (LLM~+~C2 candidates) substantially recovers C2's recall
gap, matching C1's interactions macro-F1 on three of four scenarios. It
still fails on S3: the \ac{LLM} adds static-analysis-derived edges it
cannot verify from source alone, introducing two false positives
(F1~$=$~0.667 on S3 interactions).

C8 (LLM~+~C3) partially denoises the raw trace: S3's complex
intra-component noise is the hardest case, leaving residual false
positives (F1~$=$~0.571 on S3 interactions vs.\ C3's~0.462).

C9 (LLM~+~C4) actually hurts: macro interactions F1 drops from C4's
0.914 to~0.783. On S3, the \ac{LLM} over-filters --- it misclassifies a
genuine interaction as setup-phase noise and drops it
(F1~$=$~0.333 on S3 interactions). This is the general risk when the
prior is already precise: the \ac{LLM} cannot reliably distinguish
genuine from spurious edges in a clean input, and errors become
counterproductive.

Which condition to prefer in practice: C5 or C6 guarantee perfect
reconstruction where Neo4j is available; C4 is the strongest deterministic option without the Neo4j-based reachability filter; C7 is the best LLM-only option when a static prior
is available and recall matters more than precision on S3.
...
S1a and S1b show that the guided+reachability filter (C5) eliminates
false positives by scoping the trace to only the functions reachable
from the scenario's entry points in the static call graph -- not by
requiring agreement between two independently-erring sources. Unlike
CPSCore, this codebase uses proxy objects, virtual interfaces (118
events on one representative interface) and dynamic
...
where the static call graph's reachability scope may cut a broader set
of irrelevant trace events. P2's stub-resolution observation, where the
graph-based tool located a definition invisible to code search, is
consistent with static reachability carrying signal here; but the
session collected no dynamic evidence, so it cannot confirm whether
the guided+reachability filter would achieve perfect F1 on this
codebase. That mechanism was measured only on CPSCore, via S1a, S1b,
S2 and S3 (\cref{sec:h1-c4c2}). Testing the guided+reachability
pipeline on a system of this scale and dispatch complexity is left to
future work (\cref{sec:future-work}).
...
\begin{description}
  \item[H1.] Guided instrumentation combined with the static-graph
    reachability filter (C5) achieves perfect F1~$=$~1.000 on all four
    scenarios. Guided instrumentation alone without the filter (C4)
    reaches macro F1~$=$~0.914, already exceeding either source alone;
    the reachability scope closes the remaining gap. The full-trace
    variant with the same filter (C6) also reaches 1.000, confirming
    the filter is the decisive factor, not the instrumentation
    strategy.
  ...
  \item[Practitioner session.] The proxy-leak defect was resolved using
    ...
    guided+reachability mechanism itself (\cref{sec:practitioner}).
\end{description}

The pipeline's precision benefit is therefore conditional on the static
call graph providing an accurate reachability scope for the scenario's
entry points -- useful for engineers deciding when the guided+reachability
strategy is appropriate. H3 adds a downstream caveat: a reconstructed
diagram summarises what the pipeline concluded, but attributing an
interaction to its specific source component still calls for
cross-referencing source and trace directly.

This generates a testable prediction: on a codebase with more complex
dispatch (proxy objects, virtual interfaces, unlike CPSCore), the static
call graph's reachability scope may identify a broader set of irrelevant
trace events, giving the filter more false positives to suppress while
still preserving the scenario's genuine edges. The practitioner
codebase looks like such a system; testing the guided+reachability
pipeline there remains future work (\cref{sec:future-work}).
...
Combining improves reconstruction to perfect accuracy across all
four scenarios. Condition~C5 (guided instrumentation + static
reachability filter) achieves F1~$=$~1.000 on every scenario
(S1a, S1b, S2, S3), against 0.756 for static alone (C2), 0.530 for
unfiltered dynamic alone (C3), and 0.914 for guided dynamic without the
filter (C4, \cref{sec:h1-c4c2}). Condition~C6 (full-trace + same
reachability filter) also reaches 1.000, confirming the reachability
scope is sufficient regardless of instrumentation strategy. S1a and
S1b -- found-in-the-wild instances of the same test exercising its
happy path and timeout branch respectively -- show the mechanism holds
without special construction. Whether this generalises beyond CPSCore
depends on whether the static call graph accurately captures
scenario-relevant reachability, which the practitioner session
(\cref{sec:practitioner}) motivates but does not confirm.
...
\texttt{.sysml} file, or \texttt{interactions.json}/\texttt{sequence.json}
for the reachability filter step) rather than acting invisibly, and works from the live
...
\begin{description}
  ...
  \item[No scenario exercises the filter at its limit.] All
    four scenarios are found-in-the-wild,
    strengthening confidence that the guided+reachability
    mechanism (\cref{sec:h1-c4c2}) generalises beyond constructed cases.
    This also means no scenario exercises a path where the reachability
    filter removes a genuine edge that C4 would have retained; every
    C4 false positive is setup-phase boilerplate absent from the
    scenario's architectural scope. Whether the filter can suppress
    false positives on a scenario with genuine architectural paths
    outside the entry-point traversal remains untested and is
