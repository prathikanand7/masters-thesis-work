...
Briand \etal \cite{briand:seqdiag} formalise the mapping between runtime
...
\Cref{tab:related-work-summary} summarises the approaches reviewed above
...
In particular, no prior work: (i) fuses static and trace information into a
unified \acl{PG}; (ii) applies dependence-based slicing to that graph for
scenario filtering; and (iii) targets \sysml as the output formalism.
