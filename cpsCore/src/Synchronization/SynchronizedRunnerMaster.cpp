...
#include <mutex>
#include "cpsCore/Utilities/Runtime/Instrumentation.hpp"
		...
		shmAllocated_(true), timeout_(Seconds(1)), numOfRunners_(numOfRunners)
{
	...
	{
		CPSLOG_WARN << "Synchronizer already exists. Trying to use existing. Might fail.";
